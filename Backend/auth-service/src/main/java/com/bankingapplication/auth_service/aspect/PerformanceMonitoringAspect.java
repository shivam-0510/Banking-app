...
public class PerformanceMonitoringAspect {
    ...
    @Pointcut("execution(* com.bankingapplication.auth_service.service.*.*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* com.bankingapplication.auth_service.repository.*.*(..))")
    ...
    @Around("repositoryMethods() && !execution(* com.bankingapplication.auth_service.repository.*.count*(..))")
